...
bedtools bedtobam -i outputs/sample1_annotated.bed -g $genome > outputs/sample1_annotated.bam
samtools sort outputs/sample1_annotated.bam -o outputs/sample1_annotated_sorted.bam
samtools index outputs/sample1_annotated_sorted.bam
